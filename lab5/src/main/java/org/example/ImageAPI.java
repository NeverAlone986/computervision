...
public class ImageAPI {
    ...
    public ImageAPI() throws Exception {
        ...
        // Преобразуем относительный путь к абсолютному относительно корня проекта
        java.io.File libFile = new java.io.File(nativeLibraryPath);
        String absoluteLibPath = libFile.isAbsolute() ? libFile.getAbsolutePath() : 
            new java.io.File(System.getProperty("user.dir"), nativeLibraryPath).getAbsolutePath();
    ...
    public void floodFillImage(String imagePath, Point seedPoint, Scalar newVal, Scalar loDiff, Scalar upDiff) {
        ...
        Imgcodecs.imwrite("Images/1/floodFillResult.jpg", srcImage);
    }
    ...
    public void pyramidOperations(String imagePath, int levels, boolean isDown) {
        ...
        Imgcodecs.imwrite(isDown ? "Images/1/pyrDownResult.jpg" : "Images/1/pyrUpResult.jpg", result);
    }
    ...
    public void identifyRectangles(String imagePath, int width, int height) {
        ...
        Imgcodecs.imwrite("Images/1/rectanglesResult.jpg", srcImage);
    }
}