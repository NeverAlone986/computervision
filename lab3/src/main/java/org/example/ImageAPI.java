...
public class ImageAPI {
    ...
    public ImageAPI() throws Exception {
        ...
        // Преобразуем относительный путь в абсолютный относительно рабочей директории
        java.nio.file.Path libPath = java.nio.file.Paths.get(System.getProperty("user.dir"), nativeLibraryPath).toAbsolutePath();
